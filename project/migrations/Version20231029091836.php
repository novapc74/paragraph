 ...
 */
final class Version20231029091836 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('CREATE TABLE page_block (id INT AUTO_INCREMENT NOT NULL, image_id INT DEFAULT NULL, product_id INT DEFAULT NULL, title VARCHAR(255) DEFAULT NULL, text LONGTEXT DEFAULT NULL, html LONGTEXT DEFAULT NULL, type VARCHAR(255) NOT NULL, INDEX IDX_E59A68F43DA5256D (image_id), INDEX IDX_E59A68F44584665A (product_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8 COLLATE `utf8_unicode_ci` ENGINE = InnoDB');
        $this->addSql('ALTER TABLE page_block ADD CONSTRAINT FK_E59A68F43DA5256D FOREIGN KEY (image_id) REFERENCES media (id)');
        $this->addSql('ALTER TABLE page_block ADD CONSTRAINT FK_E59A68F44584665A FOREIGN KEY (product_id) REFERENCES product (id)');
    ...
    public function down(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE page_block DROP FOREIGN KEY FK_E59A68F44584665A');
